...
namespace Labixa.Areas.Portal.Controllers
{
    public class WebsiteAttributeController : Controller
    {
        ...
        public ActionResult Create(WebsiteAttributeFormModel model)
        {
            ...
            {
                WebsiteAtribute websiteAttribute = Mapper.Map<WebsiteAttributeFormModel, WebsiteAtribute>(model);
        ...
        public ActionResult Edit(int id)
        {
            ...
            WebsiteAttributeFormModel model = Mapper.Map<WebsiteAtribute, WebsiteAttributeFormModel>(websiteAttribute);
            if (model != null)
            {
                return View(model);
            }
